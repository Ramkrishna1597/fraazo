import {
  ...
  const stripePromise = loadStripe(
    "pk_test_51LqbftSB8LgT1BCu5vO7mh6pA6UL2liChzaV0KpvmeQqhrIDUOrBRtaOTjVwHVEVjfSw98FBOJFFacJ0bJbkYL5n00s76hrv7r"
  );
  ...
  function CheckOutStripe() {
   ...
   const cartTotal = cartItems.reduce((acc, el) => {
    ...
    const handleSubmit = async (event) => {
      ...
      var response = fetch("https://fraazo.herokuapp.com/payment/create", {
        method: "POST",
        headers: {
